...
**School Library** is a program where you see information about one school library.
...
```sh
  cd my-folder
  git clone https://github.com/rbd3/School-Library.git
```
--->
<!--
### Install
...
Feel free to check the [issues page](https://github.com/rbd3/School-Library/issues).
